...
const AccessibleCar = ({ className = '', color = '#f59e0b', animate = false }: Props) => (
  <motion.svg
    viewBox="0 0 260 120"
    className={className}
    fill="none"
  ...
  >
    <defs>
      <linearGradient id="accBody" x1="20" y1="40" x2="240" y2="100" gradientUnits="userSpaceOnUse">
        <stop stopColor={color} />
        <stop offset="1" stopColor={color} stopOpacity="0.5" />
      </linearGradient>
      <linearGradient id="accRoof" x1="80" y1="15" x2="180" y2="50" gradientUnits="userSpaceOnUse">
    ...
    <motion.g filter="url(#accGlow)">
      ...
      <circle cx="130" cy="55" r="16" fill={color} opacity="0.15" stroke={color} strokeWidth="1.5" />
      <path d="M124 45 L124 65 M118 55 L136 55" stroke={color} strokeWidth="3" strokeLinecap="round" />
      <path d="M120 48 Q124 42 128 48" stroke={color} strokeWidth="2" strokeLinecap="round" fill="none" />

      <rect x="40" y="58" width="8" height="5" rx="2" fill={color} opacity="0.4" />
    </motion.g>
  </motion.svg>
);

export default AccessibleCar;
