...
// 6 Feature Cards matching mockup with dual icons & status badges
const featureCards = [
  {
    ...
    title: 'IoT Device',
    description: 'High-frequency ultrasonic & optical bay sensors detect vehicle presence in 10ms, synchronizing with smart barriers.',
  ...
  },
  {
    ...
    title: '24/7 Support',
    description: 'Continuous AI concierge and live human operator fallback for automated lane clearances and assistance.',
  ...
  },
  {
    ...
    description: 'Turn-by-turn indoor wayfinding directs your car straight to your reserved bay number without circling or delay.',
    iconColor: 'text-[#00FFA3]',
    glowColor: 'hover:shadow-[0_0_25px_rgba(0,255,163,0.25)] hover:border-[#00FFA3]/40',
  },
  {
    ...
    badgeColor: 'text-[#00D2FF] bg-[#00D2FF]/10 border-[#00D2FF]/30',
    title: 'Dynamic Rates',
    description: 'Transparent live pricing, off-peak discounts, and instant cashless digital wallet billing with e-invoicing.',
    iconColor: 'text-[#00D2FF]',
    glowColor: 'hover:shadow-[0_0_25px_rgba(0,210,255,0.25)] hover:border-[#00D2FF]/40',
  },
  {
...
// 4 Simple Steps with Laser Path
const roadmapSteps = [
  {
    id: 1,
    num: '1',
...
// Built for Everyone Audience Cards with App Mockup visuals
const audienceCards = [
  {
    title: 'For Drivers',
    type: 'mobile',
    points: [
      ...
      'Turn-by-turn indoor bay guidance',
...
const faqs = [
  {
    ...
    a: 'Simply click "Book Parking", select your garage location, choose your vehicle type, and pick a time slot. Once confirmed, you will instantly receive your encrypted digital QR parking pass.',
  },
  {
...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-[#080C15] text-white font-sora overflow-x-hidden selection:bg-[#00FFA3] selection:text-black">
      ...
      {/* =========================================================================
          1. HERO SECTION (Neon Cyber Tech Theme matching Mockup)
          ========================================================================= */}
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-gray-300 max-w-lg leading-relaxed font-sans">
              Real-time predictive parking solutions for modern cities. Powered by autonomous IoT sensor networks, automated gates, and turn-by-turn indoor wayfinding.
            </p>
            ...
            <div className="absolute -bottom-10 -left-12 w-64 h-24 pointer-events-none opacity-70 hidden md:block">
              <svg viewBox="0 0 200 80" fill="none" className="w-full h-full">
                <path
                  ...
                  stroke="url(#neon-laser-grad)"
                  strokeWidth="3.5"
                  strokeLinecap="round"
                />
                <defs>
                  <linearGradient id="neon-laser-grad" x1="180" y1="10" x2="10" y2="75" gradientUnits="userSpaceOnUse">
      ...
      {/* =========================================================================
          2. "EVERYTHING YOU NEED" (6 Cyber Cards with Hover Neon Green Glow & Wireframes)
          ========================================================================= */}
      <section className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {featureCards.map((card, idx) => (
            ...
            >
              {/* Subtle Car Wireframe Vector Outline in Background that lights up on hover */}
      ...
      <section className="relative z-10 py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto overflow-hidden">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <motion.p
            ...
            className="text-sm sm:text-base text-gray-400 font-sans"
          >
            Interactive laser-guided user journey. The seamless autonomous process.
          </motion.p>
        </div>
        ...
        {/* Step Preview Interactive Visual with 2 Preview Cards + 4-Car Laser Track */}
        <div className="relative max-w-5xl mx-auto bg-gradient-to-b from-[#0a152d] via-[#070e20] to-[#050a14] rounded-3xl p-6 sm:p-10 border border-[#00D2FF]/25 shadow-[0_0_40px_rgba(0,210,255,0.15)] overflow-hidden">
          ...
          {/* Step 1 & 2 Interactive Glass Preview Cards directly below tabs (Matching Mockup) */}
          <div className="grid sm:grid-cols-2 gap-4 mb-8">
            {/* Preview Card 1: Touch Screen / Spot Selection */}
            <div className={`p-4 rounded-2xl cyber-card transition-all ${activeStep === 1 ? 'border-[#00FFA3]/60 shadow-[0_0_20px_rgba(0,255,163,0.2)]' : 'opacity-70'}`}>
              <div className="flex items-center gap-3.5">
                ...
                <div>
                  <span className="text-[10px] font-space text-[#00FFA3] font-bold block">INTERACTIVE SELECTION</span>
            ...
            {/* Preview Card 2: Contactless Gate Entry */}
            <div className={`p-4 rounded-2xl cyber-card transition-all ${activeStep === 2 ? 'border-[#00D2FF]/60 shadow-[0_0_20px_rgba(0,210,255,0.2)]' : 'opacity-70'}`}>
              <div className="flex items-center gap-3.5">
                ...
                <div>
                  <span className="text-[10px] font-space text-[#00D2FF] font-bold block">AUTOMATED GATE SENSOR</span>
                  <h4 className="text-sm font-bold text-white">Smart Radar Check-in</h4>
          ...
          <div className="relative w-full h-36 sm:h-44 bg-[#040812] rounded-2xl border border-cyan-500/20 flex items-center px-4 sm:px-12 overflow-hidden">
            ...
            {/* Glowing Laser Trajectory Track Line */}
            ...
            >
              <div>
                <h4 className="text-lg font-bold text-white mb-1 flex items-center gap-2">
                  <span className="text-[#00FFA3]">Step {activeStep}:</span> {roadmapSteps[activeStep - 1].title}
                </h4>
      ...
      {/* =========================================================================
          4. "BUILT FOR EVERYONE" (3 Cards with UI Mockup Screen Views)
          ========================================================================= */}
      <section className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center max-w-2xl mx-auto mb-14">
          <motion.h2
        ...
        {/* 3 Audience Cards matching Mockup Layout */}
        <div className="grid md:grid-cols-3 gap-8">
          {audienceCards.map((aud, i) => (
            ...
            >
              {/* Header Visual: App Screen / Device UI Mockup Container */}
      ...
      {/* =========================================================================
          5. "WHAT PEOPLE SAY" (Testimonials with Ambient Wireframe Car Clouds)
          ========================================================================= */}
      <section className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        
        {/* Background Subtle Wireframe Car Outlines */}
      ...
      {/* =========================================================================
          6. "FREQUENTLY ASKED QUESTIONS" (FAQ Accordion with Car Help Tag)
          ========================================================================= */}
      ...
      {/* =========================================================================
          7. "READY TO GET STARTED?" (Glowing Neon Car Silhouette & Shimmer Button)
          ========================================================================= */}
      <section className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
